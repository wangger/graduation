...
#merge(inner)
comment_data = pd.merge(reply_data, comment_data,left_on = ['id','term_id'], right_on = ['reply_id','term_id'])
print(comment_data.describe())
print(comment_data.ix[0])
comment_extract_column = ['comment_time','replyer_id']
